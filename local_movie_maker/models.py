...
class ProjectRequest:
    ...
    background_audio_workflow: str | None = None
    ...
    def from_dict(cls, value: dict[str, Any]) -> "ProjectRequest":
        ...
        background_audio_workflow = _optional_name(
            value.get("background_audio_workflow"), "ComfyUI background audio workflow"
        )
        return cls(
            prompt=prompt,
            duration=duration,
            ...
            background_audio_workflow=background_audio_workflow,
        )
